                ...
                for (int a3 = -7; a3 <= 7; a3++) {
                    for (int b3 = -7; b3 <= 7; b3++) {
                        for (int c3 = -7; c3 <= 7; c3++) {
                            int V3_calc = calculateAllOverlap(a1, b1, c1, a2, b2, c2, a3, b3, c3);
                            int V2_calc = calculateOverlap(a1, b1, c1, a2, b2, c2) + calculateOverlap(a1, b1, c1, a3, b3, c3) + calculateOverlap(a2, b2, c2, a3, b3, c3) - 3 * V3_calc;
